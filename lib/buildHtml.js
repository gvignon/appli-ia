...
const STYLE = `
  ...
  body { font-family: Arial, "Noto Sans", "Segoe UI", "DejaVu Sans", sans-serif; max-width: 54rem; margin: 2rem auto; padding: 0 1.25rem; line-height: 1.6; font-size: 1.15rem; color: #111; background: #fff; }
  h1 { font-size: 1.9rem; }
